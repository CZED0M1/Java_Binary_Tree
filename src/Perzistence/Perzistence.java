...
public class Perzistence {
    ...
    public static void fileWriter(IAbstrDoubleList<IPobocka> seznam, String file) throws IOException {
        try (FileWriter writer = new FileWriter(file)) {
            ...
            for (IPobocka pobocka : seznam) {
                Iterator<Auto> it = pobocka.iterator(eTypProhl.HLOUBKA);
                while (it.hasNext()) {
                    writer.write(it.next().saveData());
                    writer.write("\n");
                }
    ...
    public static void fileReader(ObservableList<Auto> list,String file) throws IOException {
        Auto auto = null;
        String full;
        String[] rozdeleno;
        String spz;
